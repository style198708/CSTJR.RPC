...
namespace CSTJR.RPC.Member.Contracts
{
  ...
  [Serializable]
  #endif
  public partial class UserInfoResult : TBase
  {
    ...
    public bool IsCognizance
    {
      get
      {
        return _IsCognizance;
      }
      set
      {
        __isset.IsCognizance = true;
        this._IsCognizance = value;
      }
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("UserInfoResult");
        ...
        if (__isset.IsCognizance) {
          field.Name = "IsCognizance";
          field.Type = TType.Bool;
          field.ID = 12;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(IsCognizance);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UserInfoResult(");
      bool __first = true;
      if (MemberID != null && __isset.MemberID) {
